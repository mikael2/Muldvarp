...
//				WifiManager lWifiManager = (WifiManager) VideoIntent.this.getSystemService(Context.WIFI_SERVICE);
//				TelephonyManager lTelephonyManager = (TelephonyManager) VideoIntent.this.getSystemService(Context.TELEPHONY_SERVICE);
//				
//				////////////////////////////
...
//				}
				...
				lUriStr = "http://www.youtube.com/watch?v=MGtLGuSaVOI";
...
//				}
		...
		protected void onPostExecute(Uri pResult) {
			...
			try {
				...
				final MediaController lMediaController = new MediaController(VideoIntent.this);
				...
				mVideoView.setOnPreparedListener( new MediaPlayer.OnPreparedListener() {
					...
					public void onPrepared(MediaPlayer pMp) {
						if(isCancelled())
							return;
						VideoIntent.this.mProgressBar.setVisibility(View.GONE);
						VideoIntent.this.mProgressMessage.setVisibility(View.GONE);
					}
		...
		private void showErrorAlert() {
                    //Utkommentert for nå
//			Builder lBuilder = new AlertDialog.Builder(VideoIntent.this);
...
//			lDialog.show();
			...
			lBuilder.setPositiveButton(test, new DialogInterface.OnClickListener(){
				@Override
				public void onClick(DialogInterface pDialog, int pWhich) {
					VideoIntent.this.finish();
				}
		...
		protected void onProgressUpdate(ProgressUpdateInfo... pValues) {
			...
			VideoIntent.this.updateProgress(pValues[0].mMsg);
		}
