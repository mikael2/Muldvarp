...
// * @author johan
// */
//public class VideoMainActivity1 extends FragmentActivity implements ActionBar.TabListener {
//
...
//        pager.addTab(TAB1, CustomListFragment.class);
//        pager.addTab(TAB2, CustomListFragment.class);
//        pager.addTab(TAB3, CustomListFragment.class);
//
//
...
//
//                        //Get listView
//                        //CustomListFragment customListFragment = (CustomListFragment) getFragmentManager().findFragmentById(R.id.customlistview);
//
//                        //customListFragment.getAdapter(createListItems(response));
//
//                        break;
//                    }
