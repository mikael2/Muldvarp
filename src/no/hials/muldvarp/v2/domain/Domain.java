...
public class Domain implements Serializable {
    ...
    public void populateList(List<MuldvarpFragment> fragmentList, Context context) {
        ...
        fragmentList.add(new TextFragment("Informasjon", TextFragment.Type.INFO, R.drawable.stolen_contacts, 35));
...
//        fragmentList.add(gridFragmentList);
        ...
        fragmentList.add(new TextFragment("Opptak", TextFragment.Type.REQUIREMENT, R.drawable.stolen_notes, 35));
        fragmentList.add(new TextFragment("Datoer", TextFragment.Type.DATE, R.drawable.stolen_calender, 35));
        fragmentList.add(new TextFragment("Hjelp", TextFragment.Type.HELP, R.drawable.stolen_help, 35));
    }
